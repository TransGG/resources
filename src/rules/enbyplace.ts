...
const TEMPLATE_CONTACTING_STAFF = (contactStaffChannelText: string) =>
...
await templateRules({
    webhookVariableName: "RULES_ENBYPLACE",
    plaintextPath: "raw/rules/enbyplace.md",
    serverName: "EnbyPlace!",
    serverURL: "https://discord.gg/kaaxNBDEx6",
    ...
    rules: [
        ...
        },
        {
            ...
            subsections: [
                ...
                },
                {
                    title: "System tags:",
                    description:
                        "You must set a system tag to use PluralKit here (the bot itself will enforce this). In <#1087014899454054447>, you can use `pk;s systemtag <tag>` to set a global tag or `pk;s servertag <tag>` to set a tag for just this server. Your system tag is up to your preference; common choices include an emoji or a name with which the system identifies.",
        ...
        },
        {
            ...
            description:
                "Avoid extended discussion in the media-sharing channels <#1087014899454054449>, <#1087014899454054450>, and <#1087014899454054451> so as to not bury the media people are sharing.",
            screenreaderDescription:
        ...
        },
        {
            ...
            description:
                "Short phrases, jokes, and references in other languages are fine, but keep conversations in English. Using symbols that look like letters to spell is not allowed, including in display names.",
            subsections: [
                {
    ...
    bottomSection: [
        ...
        },
        {
            ...
            description: TEMPLATE_CONTACTING_STAFF("<#1186054373986537522>"),
        ...
        },
        {
            ...
            description: TEMPLATE_IMPORTANT_NOTICE("<#1256013555447103518>"),
